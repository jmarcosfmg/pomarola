 ...
 * @author João
 */
public class NovaTela extends javax.swing.JDialog {

    /**
     * Creates new form NovaTela
     */
    public NovaTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        jLabel1.setText(LocalTime.now().format(DateTimeFormatter.ofPattern("HH:mm")) + ", hora de parar ε=ε=┌(;￣▽￣)┘");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NovaTela dialog = new NovaTela(new javax.swing.JFrame(), true);
